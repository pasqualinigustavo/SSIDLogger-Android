...
public class WifiReceiver extends BroadcastReceiver {
    ...
    public static final String PREF_LOGACTIVE = "activeLog";
    ...
    public static boolean activeLog = true;
    public static int frequency = Constants.REFRESH_TIME;
    ...
    public static void init(Context context) {
        ...
        logFile = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)
                + File.separator + LOGFILE;
        //activeScan = pref.getBoolean(PREF_ACTIVE, false);
        activeLog = pref.getBoolean(PREF_LOGACTIVE, true);
        frequency = pref.getInt(PREF_SCANINTERVAL, Constants.REFRESH_TIME);
...
//        }
    ...
    public static void toggleLogActive(Context context) {
        activeLog = !activeLog;
        pref.edit().putBoolean(PREF_LOGACTIVE, activeLog).commit();
    }
